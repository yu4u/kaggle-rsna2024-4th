...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=dirpath, monitor="val_score", save_last=False, mode="min",
                                          filename=finename + "_{epoch:03d}_{val_score:.4f}", save_weights_only=True,
