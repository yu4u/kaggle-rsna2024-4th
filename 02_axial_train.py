...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=dirpath, monitor="val_acc", save_last=False, mode="max",
                                          filename=finename + "_{epoch:03d}_{val_acc:.4f}", save_weights_only=True,
